        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Donnie Grubat</span>
            </a>
            <ul class="dropdown-menu">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><router-link to="/dashboard"><i class="fa fa-link"></i> <span>Dashboard</span></router-link></li>
        <li><router-link to="/profile"><i class="fa fa-link"></i> <span>Profile</span></router-link></li>
        <li class="treeview">
